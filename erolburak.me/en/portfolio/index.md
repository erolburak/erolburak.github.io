...
This website is a project of mine that is used to create a static website that I developed using [Publish](https://github.com/JohnSundell/Publish). The website contains my portfolio as a Senior iOS Developer and information about me. The portfolio area lists my private apps, which can be viewed publicly on my [GitHub profile](https://github.com/erolburak"), but also apps that I worked on as an employee. You can view this project publicly [here](https://github.com/erolburak/erolburak.me).
